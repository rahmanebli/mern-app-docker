...
Docker Compose gère les services client, serveur et MongoDB. Les services communiquent entre eux et exposent les ports nécessaires.

## Réseau Docker (optionnel)

Pour permettre la communication entre les conteneurs, un réseau Docker peut être créé :
